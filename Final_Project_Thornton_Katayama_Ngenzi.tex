...
{\centering \includegraphics{Final_Project_Thornton_Katayama_Ngenzi_files/figure-latex/early plot 1-1} 

}

\caption{Sig events (early decade)}\label{fig:early plot 1}
\end{figure}
\newpage
...
\NormalTok{Beaufort\_early}\SpecialCharTok{$}\NormalTok{Date}\OtherTok{\textless{}{-}} \FunctionTok{as.Date}\NormalTok{(Beaufort\_early}\SpecialCharTok{$}\NormalTok{Date, }\StringTok{"\%Y{-}\%m{-}\%d"}\NormalTok{)}
...
\NormalTok{Plot\_early\_overall }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(Beaufort\_early, }
  ...
  \FunctionTok{geom\_point}\NormalTok{()}\SpecialCharTok{+}
   \FunctionTok{scale\_x\_date}\NormalTok{(}\AttributeTok{date\_labels =}\NormalTok{ (}\StringTok{"\%m{-}\%Y"}\NormalTok{))}\SpecialCharTok{+}
...
\NormalTok{Beaufort\_Late}\SpecialCharTok{$}\NormalTok{Date}\OtherTok{\textless{}{-}} \FunctionTok{as.Date}\NormalTok{(Beaufort\_Late}\SpecialCharTok{$}\NormalTok{Date, }\StringTok{"\%Y{-}\%m{-}\%d"}\NormalTok{)}
...
{\centering \includegraphics{Final_Project_Thornton_Katayama_Ngenzi_files/figure-latex/late plot 2-1} 

}

\caption{Overall Precipitation (late decade)}\label{fig:late plot 2}
\end{figure}
\newpage
