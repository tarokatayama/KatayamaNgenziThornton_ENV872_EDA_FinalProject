...
```{r}
# Only the first 3 are statistically significant autocorrelation trend of precipitation. The ACF starts with a log of 0, depicting the correlation of the time series, resulting in 1. 
acf(Beaufort_TS) 

pacf(Beaufort_TS) 
#Only the first 3 lag time are statistically significant while others are not.  
#And the second one is negative partial autocorrelation. 
```
